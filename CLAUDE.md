Always respond in Russian in chat.

# Mekiri — agent instructions

This is the Mekiri project itself (context-hygiene tool for AI agents; see README.md and docs/mechanics/ for the design, docs/philosophy.md for the "why").
